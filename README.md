...
# 3. 构建完成后下载 APK，传到手机安装即可
```

构建页面：[expo.dev/accounts/hyh1088/projects/xundict](https://expo.dev/accounts/hyh1088/projects/xundict)
...
A: 确认手机和电脑在**同一 WiFi**，关闭电脑防火墙重试。

### Q: 发音没声音？

A: 检查手机**媒体音量**是否开启，部分机型需要授予录音权限。
